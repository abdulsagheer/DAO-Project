...
const ProposalDetails = () => {
	...
	return (
		<div className="p-8">
			<h2 className="mb-5 text-3xl font-semibold">{proposal?.title}</h2>
			<p>
			...
			<div className="flex flex-row items-center justify-start w-full mt-4 overflow-auto">
			...
			<div
				className="flex flex-row items-center justify-start mt-4 space-x-3"
				role="group">
				{isStakeholder ? (
					<>
						<button
